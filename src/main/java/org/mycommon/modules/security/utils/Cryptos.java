...
public class Cryptos {
    ...
    public static String aesEncrypt(String input, String key) {
        byte[] encryptResult = aesEncrypt(input.getBytes(), Encodes.decodeHex(key));
    ...
    public static String aesEncrypt(String input, String key, String iv) {
        byte[] encryptResult = aesEncrypt(input.getBytes(), Encodes.decodeHex(key), Encodes.decodeHex(iv));
        return Encodes.encodeHex(encryptResult);
    }
    ...
    public static String aesDecrypt(String input, String key) {
        return aesDecrypt(Encodes.decodeHex(input), Encodes.decodeHex(key));
    }
    ...
    public static String aesDecrypt(String input, String key, String iv) {
        return aesDecrypt(Encodes.decodeHex(input), Encodes.decodeHex(key), Encodes.decodeHex(iv));
    }
